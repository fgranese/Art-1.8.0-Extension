...
from art_wb.estimators.classification.scikitlearn.art_interface import CustomScikitlearnSVC
from art_wb.attacks.evasion.sa_wb_nss import SquareAttack_WB_nss
...
def main_pipeline_wb(args):
    ...
    model_path = '{}nss_model_all.pkl'.format(args.DETECTOR.detector_dir)
